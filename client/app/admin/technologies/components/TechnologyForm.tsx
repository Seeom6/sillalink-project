...
import { CreateTechnologyPayload, UpdateTechnologyPayload } from "@/app/api/technology/technology-api-type";
...
interface AddTechnologyFormProps {
  onSubmit: (data: CreateTechnologyPayload) => void;
  onCancel: () => void;
  isLoading: boolean;
...
export const AddTechnologyForm: React.FC<AddTechnologyFormProps> = ({
  ...
  const handleFormSubmit = (data: TechnologyFormData) => {
    const payload: CreateTechnologyPayload = {
      ...
      description: `${data.name} is a ${data.category} technology used for development`,
...
interface EditTechnologyFormProps {
  ...
  onSubmit: (data: Omit<UpdateTechnologyPayload, 'id'>) => void;
  onCancel: () => void;
  isLoading: boolean;
}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            >
              ...
              <SelectContent>
                <SelectItem value={TechnologyStatus.ACTIVE}>Active</SelectItem>
                <SelectItem value={TechnologyStatus.INACTIVE}>Inactive</SelectItem>
                <SelectItem value={TechnologyStatus.DEPRECATED}>Deprecated</SelectItem>
              </SelectContent>
            </Select>
            {errors.status && (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <Input
              ...
              className={errors.proficiencyLevel ? "border-red-500" : ""}
            />
          ...
          <div>
            ...
            <Input
              ...
              className={errors.estimatedLearningHours ? "border-red-500" : ""}
            />
          ...
          <div>
            ...
            <Input
              ...
              className={errors.projectsUsedIn ? "border-red-500" : ""}
            />
